              ...
              <form onSubmit={handleSave} className="flex flex-col flex-1 overflow-hidden">
                ...
                <div className="modal-footer flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2 sm:gap-3 p-3.5 sm:p-4 border-t border-slate-100 bg-slate-50/70 shrink-0">
                  ...
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="w-full sm:w-auto min-h-[44px] px-5 py-2 rounded-xl text-xs font-semibold bg-[#143A7B] text-white hover:bg-blue-800 transition-colors shadow-xs disabled:opacity-50 cursor-pointer"
                  >
