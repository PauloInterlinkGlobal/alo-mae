...
import { Home, History, Bell, Shield, GraduationCap } from 'lucide-react';
...
export const PaiBottomNav: React.FC = () => {
  ...
  const navItems = [
    ...
    { label: 'Boletim', href: '/pai/pautas', icon: GraduationCap },
    {
      label: 'Avisos',
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 pt-1.5 pb-[max(0.6rem,env(safe-area-inset-bottom))] px-2 sm:px-3 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
