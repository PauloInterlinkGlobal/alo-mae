 ...
 */
exports.onAccessLogCreated = (0, firestore_1.onDocumentCreated)('accessLogs/{logId}', async (event) => {
    ...
    try {
        ...
        for (const parentDoc of parentQuery.docs) {
            ...
            const fcmTokens = parentData.fcmTokens || (parentData.fcmToken ? [parentData.fcmToken] : []);
 ...
 */
exports.recalculateClassStats = (0, firestore_1.onDocumentWritten)('students/{studentId}', async (event) => {
 ...
 */
exports.onMiniPautaApproved = (0, firestore_1.onDocumentUpdated)('miniPautas/{pautaId}', async (event) => {
    const beforeData = event.data?.before.data();
    const afterData = event.data?.after.data();
...
// Compatibilidade
exports.onGradeApproved = exports.onMiniPautaApproved;
